...
static int mtk_i2c_probe(struct platform_device *pdev)
{
	...
	if (i2c->default_timing_adjust)
		ret = mtk_i2c_set_speed_default_timing(i2c, clk_get_rate(i2c->clocks[speed_clk].clk));
	else
		ret = mtk_i2c_set_speed_adjust_timing(i2c, clk_get_rate(i2c->clocks[speed_clk].clk));
	if (ret) {
