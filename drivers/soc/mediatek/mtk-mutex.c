...
#define MT8189_MUTEX_MOD_DISP_COLOR1		7
...
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP0_CORE0	15
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP0_CORE1	16
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP1_CORE0	17
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP1_CORE1	18
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP2_CORE0	19
#define MT8196_MUTEX_MOD_DISP1_DSC_WRAP2_CORE1	20
#define MT8196_MUTEX_MOD0_DISP1_DSI0		23
#define MT8196_MUTEX_MOD0_DISP1_DVO		29
#define MT8196_MUTEX_MOD0_DISP1_MERGE0		31
#define MT8196_MUTEX_MOD1_DISP1_SPLITTER0	(32 + 11)
...
enum mtk_mutex_sof_id {
	...
	MUTEX_SOF_DSI2,
	MUTEX_SOF_DSI3,
	MUTEX_SOF_DP_INTF0, /* MUTEX_SOF_DVO1 uses the same sof_id */
	MUTEX_SOF_DP_INTF1,
	MUTEX_SOF_DVO0,
	DDP_MUTEX_SOF_MAX,
};
...
static const unsigned int mt8189_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	...
	[DDP_COMPONENT_CCORR2] = MT8189_MUTEX_MOD_DISP_CCORR2,
	[DDP_COMPONENT_CCORR3] = MT8189_MUTEX_MOD_DISP_CCORR3,
	...
	[DDP_COMPONENT_GAMMA1] = MT8189_MUTEX_MOD_DISP_GAMMA1,
	...
	[DDP_COMPONENT_COMP0_OUT_CB0] = MT8189_MUTEX_MOD_ALL,
	[DDP_COMPONENT_COMP0_OUT_CB1] = MT8189_MUTEX_MOD_ALL,
	[DDP_COMPONENT_COMP0_OUT_CB2] = MT8189_MUTEX_MOD_ALL,
	[DDP_COMPONENT_COMP0_OUT_CB3] = MT8189_MUTEX_MOD_ALL,
...
static const unsigned int mt8196_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	...
	[DDP_COMPONENT_MERGE0] = MT8196_MUTEX_MOD0_DISP1_MERGE0,
	[DDP_COMPONENT_POSTMASK0] = MT8196_MUTEX_MOD1_DISP_POSTMASK0,
	[DDP_COMPONENT_SPLITTER0] = MT8196_MUTEX_MOD1_DISP1_SPLITTER0,
	...
	[DDP_COMPONENT_DSC0] = MT8196_MUTEX_MOD_DISP1_DSC_WRAP0_CORE0,
	[DDP_COMPONENT_DSC1] = MT8196_MUTEX_MOD_DISP1_DSC_WRAP1_CORE0,
	[DDP_COMPONENT_DSC2] = MT8196_MUTEX_MOD_DISP1_DSC_WRAP2_CORE0,
...
static const unsigned int mt8189_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		...
		[MUTEX_SOF_DVO0] =
			MT8189_MUTEX_SOF_DVO | MT8189_MUTEX_EOF_DVO,
		[MUTEX_SOF_DP_INTF0] =
...
static const unsigned int mt8196_mutex_sof[DDP_MUTEX_SOF_MAX] = {
	[MUTEX_SOF_SINGLE_MODE] = MUTEX_SOF_SINGLE_MODE,
