...
#define MT8196_DISP_COMP_OUT_CB_TO_MERGE0_0			BIT(11)
#define MT8196_COMP_OUT_CB2_MOUT_EN			0xd10
#define MT8196_DISP_COMP_OUT_CB_TO_MERGE0_1			BIT(12)
#define MT8196_COMP_OUT_CB3_MOUT_EN			0xd18
...
#define MT8196_MERGE_OUT_CB11_MOUT_EN			0xe24
...
#define MT8196_DISP_DLI_RELAY_TO_SPLITTER0			BIT(0)
#define MT8196_SPLITTER_IN_CB3_MOUT_EN			0xebc
#define MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB11		BIT(7)
#define MT8196_SPLITTER_OUT_CB0_MOUT_EN			0xf1c
#define MT8196_DISP_SPLITTER_OUT_CB_TO_DSC0_0			BIT(1)
#define MT8196_SPLITTER_OUT_CB1_MOUT_EN			0xf24
#define MT8196_DISP_SPLITTER_OUT_CB_TO_DSC1_0			BIT(3)
...
#define MT8196_DISP_SPLITTER_OUT_CB_TO_DSC2_0			BIT(5)
...
static const struct mtk_mmsys_routes mmsys_mt8196_disp1_routing_table[] = {
	{
		...
		DDP_COMPONENT_DLI_ASYNC22, DDP_COMPONENT_SPLITTER0,
		MT8196_SPLITTER_IN_CB2_MOUT_EN, MT8196_DISP_DLI_RELAY_TO_SPLITTER0,
		MT8196_DISP_DLI_RELAY_TO_SPLITTER0
	}, {
		DDP_COMPONENT_SPLITTER0, DDP_COMPONENT_DSC0,
		MT8196_SPLITTER_OUT_CB0_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_DSC0_0,
		MT8196_DISP_SPLITTER_OUT_CB_TO_DSC0_0
	}, {
		DDP_COMPONENT_SPLITTER0, DDP_COMPONENT_DSC1,
		MT8196_SPLITTER_OUT_CB1_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_DSC1_0,
		MT8196_DISP_SPLITTER_OUT_CB_TO_DSC1_0
	}, {
		DDP_COMPONENT_DSC0, DDP_COMPONENT_MERGE0,
		MT8196_COMP_OUT_CB1_MOUT_EN, MT8196_DISP_COMP_OUT_CB_TO_MERGE0_0,
		MT8196_DISP_COMP_OUT_CB_TO_MERGE0_0
	}, {
		DDP_COMPONENT_DSC1, DDP_COMPONENT_MERGE0,
		MT8196_COMP_OUT_CB2_MOUT_EN, MT8196_DISP_COMP_OUT_CB_TO_MERGE0_1,
		MT8196_DISP_COMP_OUT_CB_TO_MERGE0_1
	}, {
		DDP_COMPONENT_MERGE0, DDP_COMPONENT_DP_INTF0,
		MT8196_MERGE_OUT_CB11_MOUT_EN, MT8196_DISP_COMP_OUT_CB_TO_DP_INTF0,
		MT8196_DISP_COMP_OUT_CB_TO_DP_INTF0
	}, {
		DDP_COMPONENT_DLI_ASYNC23, DDP_COMPONENT_DSC2,
		MT8196_SPLITTER_IN_CB3_MOUT_EN, MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB11,
		MT8196_DISP_DLI_RELAY_TO_SPLITTER_OUT_CB11
	}, {
		DDP_COMPONENT_DLI_ASYNC23, DDP_COMPONENT_DSC2,
		MT8196_SPLITTER_OUT_CB11_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_DSC2_0,
		MT8196_DISP_SPLITTER_OUT_CB_TO_DSC2_0
	}, {
		DDP_COMPONENT_DSC2, DDP_COMPONENT_DP_INTF1,
		MT8196_COMP_OUT_CB3_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2,
		...
		DDP_COMPONENT_DSC2, DDP_COMPONENT_DSI0,
		MT8196_COMP_OUT_CB3_MOUT_EN, MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2,
		MT8196_DISP_SPLITTER_OUT_CB_TO_MERGE_OUT_CB2
	}, {
		DDP_COMPONENT_DSC2, DDP_COMPONENT_DSI0,
